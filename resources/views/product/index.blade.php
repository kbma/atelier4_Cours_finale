    ...
    <table class="table">
       ...
       @foreach( $all as $c)
        <tr>
            ...
            <td>{{$c->name}}</td>
            <td>{{App\Models\Product::find($c->id)->category->name}}</td>

            <td>{{$c->updated_at}}</td>
            <td><a class="btn btn-primary" href="{{route('product.edit',$c->id)}}">Edit</a>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            Voulez vous vraiment supprimer le produit  <g>{{$c->name}} </g>?
                        </div>
